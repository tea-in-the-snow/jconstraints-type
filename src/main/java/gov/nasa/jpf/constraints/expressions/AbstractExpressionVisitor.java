...
public abstract class AbstractExpressionVisitor<R,D> implements ExpressionVisitor<R, D> {
  ...
  @Override
  public <F,E>
  R visit(CastExpression<F,E> cast, D data) { return defaultVisit(cast, data); }
  ...
  @Override
  public <E>
  R visit(NumericCompound<E> n, D data) { return defaultVisit(n, data); }
  ...
  @Override
  public <E>
  R visit(IfThenElse<E> n, D data) { return defaultVisit(n, data); }
  
  /* (non-Javadoc)
   * @see gov.nasa.jpf.constraints.api.ExpressionVisitor#visit(gov.nasa.jpf.constraints.expressions.PropositionalCompound, D)
   */
  @Override
  public R visit(PropositionalCompound n, D data) { return defaultVisit(n, data); }
  ...
  @Override
  public <E>
  R visit(UnaryMinus<E> n, D data) { return defaultVisit(n, data); }
  
  /* (non-Javadoc)
   * @see gov.nasa.jpf.constraints.api.ExpressionVisitor#visit(gov.nasa.jpf.constraints.expressions.QuantifierExpression, D)
   */
  @Override
  public R visit(QuantifierExpression q, D data) { return defaultVisit(q, data); }
  ...
  @Override
  public R visit(ReferenceComparisonExpression refCmpExpr, D data) {
    return defaultVisit(refCmpExpr, data);
  }
